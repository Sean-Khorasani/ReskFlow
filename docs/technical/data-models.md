...
5. [Delivery Domain](#delivery-domain)
...
interface MerchantAnalytics {
  ...
  performance: {
    ...
    deliveryTime: number;       // avg minutes
...
interface BlockchainTransaction {
  ...
  // Related Entity
  relatedEntity: {
    type: 'payment' | 'delivery' | 'verification';
    id: string;
  };
...
- Age: Must be 18+ for drivers, 21+ for alcohol delivery
