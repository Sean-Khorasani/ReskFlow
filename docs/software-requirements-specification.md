...
The ReskFlow is a comprehensive logistics and food delivery solution that:

- **Enables** multi-modal delivery services (packages, food, groceries, pharmacy)
...
3. **Delivery Management**: Assignment, routing, tracking, proof of delivery
...
1. **Regulatory Compliance**: GDPR, PCI DSS, local delivery regulations
...
**Priority**: Critical  
**Description**: Customers shall be able to create orders for delivery.
...
#### FR-062: NFT Receipts
**Priority**: Low  
**Description**: Issue NFT-based delivery receipts.
...
type Subscription {
  ...
  driverLocation(deliveryId: ID!): Location
}
```
