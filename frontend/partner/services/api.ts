...
export const deliveryApi = {
  ...
  assignDelivery: (deliveryId: string, driverId: string) =>
    api.post(`/partners/deliveries/${deliveryId}/assign`, { driverId }),
  
  reassignDelivery: (deliveryId: string, driverId: string) =>
    api.post(`/partners/deliveries/${deliveryId}/reassign`, { driverId }),
};
