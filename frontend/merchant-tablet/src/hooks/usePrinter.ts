        ...
        <body>
          ...
          <div class="customer">
            ...
            ${order.deliveryAddress ? `
              <div class="info">${order.deliveryAddress.street}</div>
              <div class="info">${order.deliveryAddress.city}, ${order.deliveryAddress.state} ${order.deliveryAddress.zip}</div>
            ` : ''}
          </div>
          ...
          <div class="total">
            ...
            <div class="info">Delivery: $${order.deliveryFee.toFixed(2)}</div>
