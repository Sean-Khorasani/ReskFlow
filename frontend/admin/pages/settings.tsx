                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        onChange={(e) => setSettings({
                          ...settings,
                          delivery: { ...settings.delivery, baseDeliveryFee: parseFloat(e.target.value) }
                        })}
                        InputProps={{
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        onChange={(e) => setSettings({
                          ...settings,
                          delivery: { ...settings.delivery, pricePerKm: parseFloat(e.target.value) }
                        })}
                        InputProps={{
                          startAdornment: <InputAdornment position="start">$</InputAdornment>,
                        }}
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        type="number"
                        value={settings.delivery.minDeliveryFee}
                        onChange={(e) => setSettings({
                          ...settings,
                          delivery: { ...settings.delivery, minDeliveryFee: parseFloat(e.target.value) }
                        })}
                        InputProps={{
                          startAdornment: <InputAdornment position="start">$</InputAdornment>,
                        }}
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        type="number"
                        value={settings.delivery.maxDeliveryFee}
                        onChange={(e) => setSettings({
                          ...settings,
                          delivery: { ...settings.delivery, maxDeliveryFee: parseFloat(e.target.value) }
                        })}
                        InputProps={{
                          startAdornment: <InputAdornment position="start">$</InputAdornment>,
                        }}
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        onChange={(e) => setSettings({
                          ...settings,
                          delivery: { ...settings.delivery, maxDeliveryDistance: parseFloat(e.target.value) }
                        })}
                      />
                    </Grid>
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        type="number"
                        value={settings.delivery.estimatedPrepTime}
                        onChange={(e) => setSettings({
                          ...settings,
                          delivery: { ...settings.delivery, estimatedPrepTime: parseInt(e.target.value) }
                        })}
                      />
                    </Grid>
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        onChange={(e) => setSettings({
                          ...settings,
                          delivery: { ...settings.delivery, estimatedDeliveryTime: parseInt(e.target.value) }
                        })}
                      />
                    </Grid>
                  </Grid>
