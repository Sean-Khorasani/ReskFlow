...
test.describe('Customer Order Flow', () => {
  ...
  test('should complete full order flow', async ({ page }) => {
    ...
    await page.fill('[data-testid="delivery-state"]', 'TC');
    await page.fill('[data-testid="delivery-zip"]', '12345');
    await page.fill('[data-testid="delivery-instructions"]', 'Leave at door');
  ...
  test('should save delivery address', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="delivery-street"]')).toHaveValue('123 Test Street');
  });
