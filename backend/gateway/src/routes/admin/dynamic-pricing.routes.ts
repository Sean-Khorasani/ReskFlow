...
router.post('/calculate',
  ...
  body('service').isIn(['delivery', 'service_fee', 'small_order_fee']),
...
router.get('/active',
  query('zone').optional().isString(),
  query('service').optional().isIn(['delivery', 'service_fee', 'small_order_fee']),
...
router.post('/zones',
  ...
  body('basePricing.deliveryFee').isFloat({ min: 0 }),
