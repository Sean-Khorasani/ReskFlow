...
export const config = {
  ...
  database: {
    url: process.env.DATABASE_URL || 'postgresql://delivery:delivery123@localhost:5432/delivery',
  ...
  mongodb: {
    url: process.env.MONGODB_URL || 'mongodb://delivery:delivery123@localhost:27017/delivery',
  },
  ...
  aws: {
    ...
    s3: {
      bucketName: process.env.S3_BUCKET_NAME || 'delivery-assets',
    },
    s3BucketName: process.env.S3_BUCKET_NAME || 'delivery-assets',
  },
  ...
  sendgrid: {
    ...
    fromEmail: process.env.SENDGRID_FROM_EMAIL || 'noreply@delivery.com',
  },
