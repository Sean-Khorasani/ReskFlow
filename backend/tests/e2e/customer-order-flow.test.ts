 ...
 * Tests the complete flow from browsing to delivery
 */
...
test.describe('Customer Order Flow', () => {
  ...
  test('should complete checkout', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="delivery-address"]')).toHaveValue(/123 Test Street/);
  ...
  test('should leave review after delivery', async ({ page }) => {
    ...
    // Add comment
    await page.fill('[data-testid="review-comment"]', 'Great food and fast delivery!');
