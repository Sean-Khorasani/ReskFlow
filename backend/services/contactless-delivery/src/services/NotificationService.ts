...
interface DeliveryNotification {
  type: 'contactless_confirmed' | 'delivery_approaching' | 'delivered' | 'safe_drop';
  orderId: string;
  customerId: string;
  data: any;
}
  ...
  async sendContactlessConfirmation(params: {
    ...
    await this.notificationQueue.add('send-notification', {
      ...
      data: {
        ...
        message: 'Contactless delivery has been enabled for your order',
      },
    });
  }
  ...
  async sendDeliveryApproaching(params: {
    ...
    await this.notificationQueue.add('send-notification', {
      ...
      data: {
        ...
        message: `Your delivery is approaching! ETA: ${dayjs(params.estimatedArrival).format('h:mm A')}`,
      },
    });
  }
  ...
  private shouldSendNotification(type: string, preferences: any): boolean {
    ...
    switch (type) {
      ...
      case 'delivery_approaching':
        return preferences.delivery_updates !== false;
      case 'delivered':
        return preferences.delivery_confirmation !== false;
      case 'safe_drop':
        return preferences.delivery_confirmation !== false;
      default:
        return true;
