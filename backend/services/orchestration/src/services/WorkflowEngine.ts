...
export class WorkflowEngine extends EventEmitter {
  ...
  async executeDeliveryWorkflow(deliveryData: any): Promise<any> {
    return this.executeWorkflow('delivery-assignment', deliveryData);
  }
  ...
  private loadWorkflows(): void {
    ...
    const workflows: WorkflowDefinition[] = [
        ...
        steps: [
          ...
          },
          {
            ...
            input: {
              ...
              data: {
                orderId: '{{input.orderId}}',
                estimatedDelivery: '{{output.assign-delivery.estimatedTime}}',
              },
            },
          },
        ],
      },
      {
        ...
        version: 1,
        description: 'Assign delivery to driver with fallback options',
        steps: [
          {
            id: 'find-drivers',
